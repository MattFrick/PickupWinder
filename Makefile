...
# path location for Arduino libraries (currently not used)mk20dx128.ld
...
CXXFLAGS += -I$(LIBRARYPATH)/LiquidCrystal
CXXFLAGS += -I$(LIBRARYPATH)/Encoder
CXXFLAGS += -I$(LIBRARYPATH)/EEPROM
CXXFLAGS += -I$(ARDUINOPATH)/hardware/teensy/cores/teensy3
CXXFLAGS += -DOUTSIDE_OF_ARDUINO_IDE
...
C_FILES := $(wildcard *.c)
C_FILES += $(ARDUINOPATH)/hardware/teensy/cores/teensy3/eeprom.c
